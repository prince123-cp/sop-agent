...
const REFUND_TERMS_REGEX = /(refund|return|term|terms|condition|conditions|cancellation|cancel|exchange|eligible|eligibility|timeline|fee|charges|shipping)/i;
